    ...
    <div class="addEdit-block">
        <el-form
            ...
            <el-row>
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="报名编号" prop="qingjiaUuidNumber">
                       <el-input v-model="ruleForm.qingjiaUuidNumber"
                                 placeholder="报名编号" clearable  :readonly="ro.qingjiaUuidNumber"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="报名编号" prop="qingjiaUuidNumber">
                           <el-input v-model="ruleForm.qingjiaUuidNumber"
            ...
            <input id="yonghuId" name="yonghuId" type="hidden">
                <el-col :span="24">
                    <el-form-item v-if="type!='info'"  label="理由" prop="qingjiaText">
                        <el-input type="textarea"  :readonly="ro.qingjiaText" v-model="ruleForm.qingjiaText" placeholder="理由"></el-input>
                    </el-form-item>
                    <div v-else-if="type=='info'">
                        <el-form-item v-if="ruleForm.qingjiaText" label="理由" prop="qingjiaText">
            ...
            <el-col :span="12" v-if="type=='info'">
                <div>
                    <el-form-item v-if="ruleForm.qingjiaYesnoTypes" label="报名状态" prop="qingjiaYesnoTypes">
                        <el-input v-model="ruleForm.qingjiaYesnoValue" placeholder="报名状态" readonly></el-input>
                    </el-form-item>
                </div>
            </el-col>
            <el-col :span="12" v-if="type=='info'">
            ...
            <el-col :span="12" v-if="type=='info'">
                ...
                <el-col :span="12">
                    <el-form-item v-if="type!='info' && !ro.qingjiaTime"  class="input" label="预约时间" prop="qingjiaTime">
                        <el-date-picker
                    ...
                    <div v-else-if="type=='info'">
                        <el-form-item v-if="ruleForm.qingjiaTime" label="预约时间" prop="qingjiaTime">
