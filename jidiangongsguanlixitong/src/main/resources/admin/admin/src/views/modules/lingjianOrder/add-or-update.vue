    ...
    <div class="addEdit-block">
        <el-form
            ...
            <el-row>
                ...
                <el-col :span="12"  v-if="sessionTable !='lingjian'">
                    <el-form-item class="select" v-if="type!='info'"  label="机电零件" prop="lingjianId">
                        <el-select v-model="ruleForm.lingjianId" :disabled="ro.lingjianId" filterable placeholder="请选择机电零件" @change="lingjianChange">
                            <el-option
                                    v-for="(item,index) in lingjianOptions"
                                    v-bind:key="item.id"
                                    :label="item.lingjianName"
                                    :value="item.id">
                            </el-option>
                        </el-select>
                    </el-form-item>
                ...
                <el-col :span="12"  v-if="sessionTable !='lingjian' ">
                    <el-form-item class="input" v-if="type!='info'"  label="机电零件名称" prop="lingjianName">
                        <el-input v-model="lingjianForm.lingjianName"
                                  placeholder="机电零件名称" clearable readonly></el-input>
                    </el-form-item>
                    <div v-else-if="type=='info'">
                ...
                <el-col :span="12" v-if="sessionTable !='lingjian' ">
                    <el-form-item class="upload" v-if="type!='info' && !ro.lingjianPhoto" label="机电零件照片" prop="lingjianPhoto">
                        <img style="margin-right:20px;" v-bind:key="index" v-for="(item,index) in (lingjianForm.lingjianPhoto || '').split(',')" :src="$base.url+item" width="100" height="100">
                    </el-form-item>
                    <div v-else-if="type=='info'">
                ...
                <el-col :span="12"  v-if="sessionTable !='lingjian' ">
                    <el-form-item class="input" v-if="type!='info'"  label="机电零件类型" prop="lingjianValue">
                        <el-input v-model="lingjianForm.lingjianValue"
                                  placeholder="机电零件类型" clearable readonly></el-input>
                    </el-form-item>
                    <div v-else-if="type=='info'">
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="订单编号" prop="lingjianOrderUuidNumber">
                       <el-input v-model="ruleForm.lingjianOrderUuidNumber"
                                 placeholder="订单编号" clearable  :readonly="ro.lingjianOrderUuidNumber"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="订单编号" prop="lingjianOrderUuidNumber">
                           <el-input v-model="ruleForm.lingjianOrderUuidNumber"
                                     placeholder="订单编号" readonly></el-input>
                       </el-form-item>
                   </div>
               </el-col>
            <input id="lingjianId" name="lingjianId" type="hidden">
            ...
            <input id="yonghuId" name="yonghuId" type="hidden">
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="实付价格" prop="lingjianOrderTruePrice">
                       <el-input v-model="ruleForm.lingjianOrderTruePrice"
                                 placeholder="实付价格" clearable  :readonly="ro.lingjianOrderTruePrice"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="实付价格" prop="lingjianOrderTruePrice">
                           <el-input v-model="ruleForm.lingjianOrderTruePrice"
                ...
                <el-col :span="12">
                    <el-form-item class="select" v-if="type!='info'"  label="订单类型" prop="lingjianOrderTypes">
                        <el-select v-model="ruleForm.lingjianOrderTypes" :disabled="ro.lingjianOrderTypes" placeholder="请选择订单类型">
                            <el-option
                                v-for="(item,index) in lingjianOrderTypesOptions"
                    ...
                    <div v-else-if="type=='info'">
                        <el-form-item class="input" label="订单类型" prop="lingjianOrderValue">
                        <el-input v-model="ruleForm.lingjianOrderValue"
    ...
    export default {
        data() {
            return {
                ...
                ruleForm: {
                    lingjianOrderUuidNumber: new Date().getTime(),
                    lingjianId: '',
                    kehuId: '',
                    yonghuId: '',
                    buyNumber: '',
                ...
                yonghuOptions : [],
                rules: {
                   lingjianOrderUuidNumber: [
                              { required: true, message: '订单编号不能为空', trigger: 'blur' },
                          ],
                   lingjianId: [
                              { required: true, message: '机电零件不能为空', trigger: 'blur' },
                              {  pattern: /^[0-9]*$/,
                                  message: '只允许输入整数',
                                  trigger: 'blur'
                              }
        ...
        created() {
            ...
            //获取下拉框信息
                this.$http({
                    url:`dictionary/page?page=1&limit=100&sort=&order=&dicCode=lingjian_order_types`,
                    method: "get"
                }).then(({ data }) => {
                    if (data && data.code === 0) {
                        this.lingjianOrderTypesOptions = data.data.list;
                    }
                });
         ...
         this.$http({
             url: `lingjian/page?page=1&limit=100`,
             method: "get"
         }).then(({ data }) => {
             if (data && data.code === 0) {
                this.lingjianOptions = data.data.list;
            }
         });
         this.$http({
        ...
        methods: {
            ...
            info(id) {
                let _this =this;
                _this.$http({
                    url: `lingjianOrder/info/${id}`,
                    method: 'get'
                }).then(({ data }) => {
                    if (data && data.code === 0) {
                        _this.ruleForm = data.data;
                        _this.kehuChange(data.data.kehuId)
                        _this.lingjianChange(data.data.lingjianId)
            ...
            onSubmit() {
                this.$refs["ruleForm"].validate(valid => {
                    if (valid) {
                        this.$http({
                            url:`lingjianOrder/${!this.ruleForm.id ? "save" : "update"}`,
                            method: "post",
                            data: this.ruleForm
                        }).then(({ data }) => {
                            if (data && data.code === 0) {
                                this.$message({
                                    ...
                                    onClose: () => {
                                        ...
                                        this.parent.lingjianOrderCrossAddOrUpdateFlag = false;
                                        this.parent.search();
