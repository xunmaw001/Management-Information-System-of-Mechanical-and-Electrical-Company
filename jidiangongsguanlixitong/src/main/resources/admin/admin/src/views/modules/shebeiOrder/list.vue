        ...
        <div v-if="showFlag">
            <el-form :inline="true" :model="searchForm" class="form-content">
                <el-row :gutter="20" class="slt" :style="{justifyContent:contents.searchBoxPosition=='1'?'flex-start':contents.searchBoxPosition=='2'?'center':'flex-end'}">
                    ...
                    <el-form-item :label="contents.inputTitle == 1 ? '机电设备名称' : ''">
                        <el-input prefix-icon="el-icon-search" v-model="searchForm.shebeiName" placeholder="机电设备名称" clearable></el-input>
                    </el-form-item>
                                                             
                    <el-form-item :label="contents.inputTitle == 1 ? '机电设备类型' : ''">
                        <el-select v-model="searchForm.shebeiTypes" placeholder="请选择机电设备类型">
                            <el-option label="=-请选择-=" value=""></el-option>
                            <el-option
                ...
                <el-row class="ad" :style="{justifyContent:contents.btnAdAllBoxPosition=='1'?'flex-start':contents.btnAdAllBoxPosition=='2'?'center':'flex-end'}">
                    <el-form-item>
                        ...
                        <a style="text-decoration:none" class="el-button el-button--success"
                           ...
                           href="http://localhost:8080/jidiangongsguanlixitong/upload/shebeiOrderMuBan.xls"
                        >批量导入机电设备订单数据模板</a>
                        &nbsp;
                        <el-upload
                                v-if="isAuth('shebeiOrder','导入导出')"
            ...
            <el-button v-if="isAuth('shebeiOrder','订单') && scope.row.shebeiOrderTypes == 101 && sessionTable=='yonghu' && userId==scope.row.yonghuId" type="primary" icon="el-icon-sold-out" size="mini" @click="refund(scope.row.id)">退款</el-button>
            <el-button v-if="isAuth('shebeiOrder','订单') && sessionTable=='yonghu' && userId==scope.row.yonghuId" type="primary" icon="el-icon-reading" size="mini" @click="receiving(scope.row.id)">收货</el-button>
    ...
    //当前表下拉框搜索条件
            ...
            json_fields: {
                //级联表字段
                     ...
                     '现有余额': 'newMoney',
                     '机电设备名称': 'shebeiName',
                     '机电设备编号': 'shebeiUuidNumber',
                     '机电设备照片': 'shebeiPhoto',
                     '机电设备类型': 'shebeiTypes',
                     '机电设备库存': 'shebeiKucunNumber',
                     '现价/积分': 'shebeiNewMoney',
                     '机电设备热度': 'shebeiClicknum',
            ...
            chartDialog() {
                ...
                let params = {
                    ...
                    thisTable : {//当前表
                        ...
                        sumColum : 'shebei_order_true_price', //求和字段
