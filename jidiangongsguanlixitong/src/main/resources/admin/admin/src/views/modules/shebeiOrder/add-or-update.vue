        ...
        <el-form
            ...
            <el-row>
                ...
                <el-col :span="12"  v-if="sessionTable !='shebei'">
                    <el-form-item class="select" v-if="type!='info'"  label="机电设备" prop="shebeiId">
                        <el-select v-model="ruleForm.shebeiId" :disabled="ro.shebeiId" filterable placeholder="请选择机电设备" @change="shebeiChange">
                            <el-option
                ...
                <el-col :span="12"  v-if="sessionTable !='shebei' ">
                    <el-form-item class="input" v-if="type!='info'"  label="机电设备名称" prop="shebeiName">
                        <el-input v-model="shebeiForm.shebeiName"
                                  placeholder="机电设备名称" clearable readonly></el-input>
                    </el-form-item>
                    <div v-else-if="type=='info'">
                ...
                <el-col :span="12"  v-if="sessionTable !='shebei' ">
                    <el-form-item class="input" v-if="type!='info'"  label="机电设备类型" prop="shebeiValue">
                        <el-input v-model="shebeiForm.shebeiValue"
                                  placeholder="机电设备类型" clearable readonly></el-input>
                    </el-form-item>
                    <div v-else-if="type=='info'">
        ...
        data() {
            return {
                ...
                rules: {
                   ...
                   shebeiId: [
                              { required: true, message: '机电设备不能为空', trigger: 'blur' },
                              {  pattern: /^[0-9]*$/,
                                  message: '只允许输入整数',
                                  trigger: 'blur'
                              }
