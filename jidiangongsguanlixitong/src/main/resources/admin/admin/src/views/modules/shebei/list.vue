                ...
                <el-row class="ad" :style="{justifyContent:contents.btnAdAllBoxPosition=='1'?'flex-start':contents.btnAdAllBoxPosition=='2'?'center':'flex-end'}">
                    <el-form-item>
                        ...
                        <a style="text-decoration:none" class="el-button el-button--success"
                           ...
                           href="http://localhost:8080/jidiangongsguanlixitong/upload/shebeiMuBan.xls"
                        >批量导入机电设备数据模板</a>
                        &nbsp;
                        <el-upload
                                v-if="isAuth('shebei','导入导出')"
                ...
                <el-table class="tables" :size="contents.tableSize" :show-header="contents.tableShowHeader"
                    ...
                    <el-table-column width="300" :align="contents.tableAlign"
                        ...
                        <template slot-scope="scope">
                            ...
                            <!--<el-button v-if="isAuth('shebei','修改')" type="primary" icon="el-icon-add-location" size="mini" @click="plusShebeiKucunNumber(scope.row.id,scope.row.shebeiKucunNumber)">增加机电设备库存</el-button>-->
                            <!--<el-button v-if="isAuth('shebei','修改')" type="primary" icon="el-icon-delete-location" size="mini" @click="reduceShebeiKucunNumber(scope.row.id,scope.row.shebeiKucunNumber)">减少机电设备库存</el-button>-->
    ...
    //当前表下拉框搜索条件
        ...
        methods: {
			...
			//数据不为空放值
				...
				//标题
				this.shebeiKucunNumberTitle = '增加机电设备库存'
			},
			//减少机电设备库存
			...
			//数据不为空放值
				...
				this.shebeiKucunNumberVisible = true;
				//标题
				this.shebeiKucunNumberTitle = '减少机电设备库存'
			},
			//提交用户操作机电设备库存数量
			addShebeiKucunNumber(){
				...
				if(this.kucunNumberTypes == "+"){
					...
					if(this.shebeiKucunNumber < this.kucunNumber || this.kucunNumber <= 0){
						this.$message.error('机电设备库存不足不能减少');
						return false;
					}else{
						maxNumber = this.shebeiKucunNumber - this.kucunNumber
					}
